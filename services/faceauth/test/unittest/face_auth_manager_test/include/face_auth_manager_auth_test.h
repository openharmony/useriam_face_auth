 ...
 */
#ifndef FACE_AUTH_MANAGER_AUTH_TEST_H
#define FACE_AUTH_MANAGER_AUTH_TEST_H
#include <iostream>
#include <fstream>
#include <thread>
...
class FaceAuthManagerTest : public testing::Test {
public:
    ...
    void WriteInitFile(int32_t caseNum, int32_t codeNum, std::map<int32_t, ResultInfo> resultInfos_);
    void WriteReleaseFile(int32_t caseNum, int32_t codeNum, std::map<int32_t, ResultInfo> resultInfos_);
    void CPPAPI_Function_GetRemainingNum_0100_Auth(int32_t num, std::map<int32_t, ResultInfo> resultInfos_);
};
...
#endif // FACE_AUTH_MANAGER_AUTH_TEST_H
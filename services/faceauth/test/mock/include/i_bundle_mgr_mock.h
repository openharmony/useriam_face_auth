...
#ifndef XXX_APPEXECFWK_INTERFACES_INNERKITS_APPEXECFWK_CORE_INCLUDE_BUNDLEMGR_BUNDLE_MGR_INTERFACE_H
#define XXX_APPEXECFWK_INTERFACES_INNERKITS_APPEXECFWK_CORE_INCLUDE_BUNDLEMGR_BUNDLE_MGR_INTERFACE_H
...
public:
     ...
     */
    virtual bool DumpInfos(const MockDumpFlag flag, const std::string &bundleName, std::string &result) = 0;
    /**
